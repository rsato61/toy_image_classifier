...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8021040
SOPC_SYSID_FLAG += --sidp=0x8021040
ELF_PATCH_FLAG  += --sidp 0x8021040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1527473683
SOPC_SYSID_FLAG += --timestamp=1527473683
ELF_PATCH_FLAG  += --timestamp 1527473683
