...
`timescale 1 ps / 1 ps
module cpu_mm_interconnect_1 (
		input  wire        clk_0_clk_clk,                              //                            clk_0_clk.clk
		input  wire        cpu_nios_reset_reset_bridge_in_reset_reset, // cpu_nios_reset_reset_bridge_in_reset.reset
		input  wire [12:0] cpu_nios_instruction_master_address,        //          cpu_nios_instruction_master.address
	...
	wire  [12:0] cpu_nios_instruction_master_translator_avalon_universal_master_0_address;       // cpu_nios_instruction_master_translator:uav_address -> cpu_nios_instruction_master_agent:av_address
	...
	wire         rsp_mux_src_valid;                                                              // rsp_mux:src_valid -> cpu_nios_instruction_master_agent:rp_valid
	wire  [84:0] rsp_mux_src_data;                                                               // rsp_mux:src_data -> cpu_nios_instruction_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                              // cpu_nios_instruction_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [1:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> cpu_nios_instruction_master_agent:rp_channel
	wire         rsp_mux_src_startofpacket;                                                      // rsp_mux:src_startofpacket -> cpu_nios_instruction_master_agent:rp_startofpacket
	wire         rsp_mux_src_endofpacket;                                                        // rsp_mux:src_endofpacket -> cpu_nios_instruction_master_agent:rp_endofpacket
	...
	wire  [12:0] cpu_nios_debug_mem_slave_agent_m0_address;                                      // cpu_nios_debug_mem_slave_agent:m0_address -> cpu_nios_debug_mem_slave_translator:uav_address
	...
	wire  [85:0] cpu_nios_debug_mem_slave_agent_rf_source_data;                                  // cpu_nios_debug_mem_slave_agent:rf_source_data -> cpu_nios_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [85:0] cpu_nios_debug_mem_slave_agent_rsp_fifo_out_data;                               // cpu_nios_debug_mem_slave_agent_rsp_fifo:out_data -> cpu_nios_debug_mem_slave_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                              // cmd_mux:src_valid -> cpu_nios_debug_mem_slave_agent:cp_valid
	wire  [84:0] cmd_mux_src_data;                                                               // cmd_mux:src_data -> cpu_nios_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                              // cpu_nios_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                            // cmd_mux:src_channel -> cpu_nios_debug_mem_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                      // cmd_mux:src_startofpacket -> cpu_nios_debug_mem_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                        // cmd_mux:src_endofpacket -> cpu_nios_debug_mem_slave_agent:cp_endofpacket
	...
	wire  [12:0] onchip_memory_s1_agent_m0_address;                                              // onchip_memory_s1_agent:m0_address -> onchip_memory_s1_translator:uav_address
	...
	wire  [85:0] onchip_memory_s1_agent_rf_source_data;                                          // onchip_memory_s1_agent:rf_source_data -> onchip_memory_s1_agent_rsp_fifo:in_data
	...
	wire  [85:0] onchip_memory_s1_agent_rsp_fifo_out_data;                                       // onchip_memory_s1_agent_rsp_fifo:out_data -> onchip_memory_s1_agent:rf_sink_data
	...
	wire  [84:0] cmd_mux_001_src_data;                                                           // cmd_mux_001:src_data -> onchip_memory_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                          // onchip_memory_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire         cpu_nios_instruction_master_agent_cp_valid;                                     // cpu_nios_instruction_master_agent:cp_valid -> router:sink_valid
	wire  [84:0] cpu_nios_instruction_master_agent_cp_data;                                      // cpu_nios_instruction_master_agent:cp_data -> router:sink_data
	wire         cpu_nios_instruction_master_agent_cp_ready;                                     // router:sink_ready -> cpu_nios_instruction_master_agent:cp_ready
	wire         cpu_nios_instruction_master_agent_cp_startofpacket;                             // cpu_nios_instruction_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire         cpu_nios_instruction_master_agent_cp_endofpacket;                               // cpu_nios_instruction_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire         cpu_nios_debug_mem_slave_agent_rp_valid;                                        // cpu_nios_debug_mem_slave_agent:rp_valid -> router_001:sink_valid
	wire  [84:0] cpu_nios_debug_mem_slave_agent_rp_data;                                         // cpu_nios_debug_mem_slave_agent:rp_data -> router_001:sink_data
	wire         cpu_nios_debug_mem_slave_agent_rp_ready;                                        // router_001:sink_ready -> cpu_nios_debug_mem_slave_agent:rp_ready
	wire         cpu_nios_debug_mem_slave_agent_rp_startofpacket;                                // cpu_nios_debug_mem_slave_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         cpu_nios_debug_mem_slave_agent_rp_endofpacket;                                  // cpu_nios_debug_mem_slave_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [84:0] onchip_memory_s1_agent_rp_data;                                                 // onchip_memory_s1_agent:rp_data -> router_002:sink_data
	...
	wire         cpu_nios_debug_mem_slave_agent_rdata_fifo_src_valid;                            // cpu_nios_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] cpu_nios_debug_mem_slave_agent_rdata_fifo_src_data;                             // cpu_nios_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         cpu_nios_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter:in_0_ready -> cpu_nios_debug_mem_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                  // avalon_st_adapter:out_0_valid -> cpu_nios_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                   // avalon_st_adapter:out_0_data -> cpu_nios_debug_mem_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                  // cpu_nios_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                  // avalon_st_adapter:out_0_error -> cpu_nios_debug_mem_slave_agent:rdata_fifo_sink_error
	wire         onchip_memory_s1_agent_rdata_fifo_src_valid;                                    // onchip_memory_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] onchip_memory_s1_agent_rdata_fifo_src_data;                                     // onchip_memory_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         onchip_memory_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_001:in_0_ready -> onchip_memory_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                              // avalon_st_adapter_001:out_0_valid -> onchip_memory_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                               // avalon_st_adapter_001:out_0_data -> onchip_memory_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                              // onchip_memory_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                              // avalon_st_adapter_001:out_0_error -> onchip_memory_s1_agent:rdata_fifo_sink_error
	...
	cpu_mm_interconnect_1_router router (
	...
	cpu_mm_interconnect_1_router_001 router_001 (
	...
	cpu_mm_interconnect_1_router_001 router_002 (
	...
	cpu_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (cpu_nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (cpu_nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (cpu_nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (cpu_nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (cpu_nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (cpu_nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
